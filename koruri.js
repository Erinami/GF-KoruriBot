...
bot.on("message", msg => {
	...
	idleArray = ["What do you think you're doing?", "Are you trying to say I'm short!?", "Who do you think I am... geez.", "I'll forgive you because I feel good today. It's a special occasion.", "Are you... trying to pick a fight?"];
	...
	// initial check if it's a help command - which is handled differently from that commands block above

	// now check if its a mention - that's also different!
